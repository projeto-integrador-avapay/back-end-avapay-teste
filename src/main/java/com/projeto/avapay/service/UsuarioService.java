...
public class UsuarioService {
	...
	public UsuarioDTO criarUsuario(CriarUsuarioDTO criarUsuarioDTO, boolean isAdmin) {
		...
		return new UsuarioDTO(novoUsuario.getId(), novoUsuario.getNome(), novoUsuario.getEmail(),
				novoUsuario.getTelefone(), novoUsuario.getTipoUsuario());
	}
	...
	public UsuarioDTO atualizarUsuario(Long id, CriarUsuarioDTO usuarioAtualizado) {
		...
		return new UsuarioDTO(usuarioExistente.getId(), usuarioExistente.getNome(), usuarioExistente.getEmail(),
				usuarioExistente.getTelefone(), usuarioExistente.getTipoUsuario());
	}
	...
	public List<UsuarioDTO> buscarTodosUsuarios() {
		...
		return usuarios.stream().map(usuario -> new UsuarioDTO(usuario.getId(), usuario.getNome(), usuario.getEmail(),
				usuario.getTelefone(), usuario.getTipoUsuario())).collect(Collectors.toList());
	}
